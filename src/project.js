    ...
    var a = e("./GameManager"),
      ...
      p = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          1 != e && (this.bencichengji.getComponent(cc.Sprite).spriteFrame = this.bencichengjiarr[e - 1], this.gengduoyouxi.getComponent(cc.Sprite).spriteFrame = this.gengduoyouxiarr[e - 1]), this.continueTip.getComponent(cc.Label).string = 1 == e ? "\u70b9\u51fb\u7ee7\u7eed" : 2 == e ? "\u9ede\u64ca\u7e7c\u7e8c" : 4 == e ? "\ud55c\ud310\ub9c8\uc548\u0021" : "Click Continue", this.reStartBtn.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(.5, 1.1), cc.scaleTo(.55, 1), cc.delayTime(.5)))), cc.tween(this.moreGameBtn).to(.5, {
            scale: 1.1
          }).to(.5, {
            scale: 1
          ...
          t > 94 && (t = 94);
          var n = 5 + t;
          return "\u51fb\u8d25\u4e86\u5168\u7403" + n + "%\u7684\u73a9\u5bb6\uff01", ["\u51fb\u8d25\u4e86\u5168\u7403" + n + "%\u7684\u73a9\u5bb6\uff01", "\u64ca\u6557\u4e86\u5168\u7403" + n + "%\u7684\u73a9\u5bb6\uff01", "Beat " + n + " % of global players", "\uc804 \uc138\uacc4 " + n + "%\uc758 \ud558\ub354\ub188 \ub97C\u0021 \uc774\uae34 \ub098 \ud750\ud5e4\ud5e4"][i.default.returnCurrentLanType() - 1]
      ...
      m = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          a.default.playNum, a.default.bgNumber >= 3 && (a.default.bgNumber = 0), a.default.bgNumber++, a.default.playNum++, cc.tween(this.lineNode.children[0]).to(.3, {
            ...
            this.fruitS = ["Kane", "Yuhi", "Bakwi", "Stoking", "BlueMary", "HanHwa", "Bae", "PinkMurderer", "KeSook", "MoeMoe", "Koker", "KokuranBo" ],
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          if (clickChangeFruit) {
            if(gameFunction.default.Instance.targetFruit) {
              ...
              gameFunction.default.Instance.createOneFruit(Math.floor(Math.random()*8));
            }
            return;
          }
